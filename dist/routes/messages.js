...
router.post('/send/text', (0, express_validator_1.body)('number').isString().notEmpty(), (0, express_validator_1.body)('message').isString().notEmpty(), request_validator_1.default, controller.send_text);
